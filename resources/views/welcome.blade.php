          ...
          <div class="row min-vh-100 align-items-center align-content-center">
              <div class="col-md-6 ">
                  <div class="home-img text-center">
                      <img class="img rounded-circle mw-100" src={{ url('/images/teacher.svg') }} alt="teacher.svg" />
                  </div>
              </div>
              <div class="col-md-6 order-md-first">
                  <div class="home-text">
                      <p class="text-muted mb-1">Hello there</p>
                      <h1 class="text-danger text-uppercase fs-1 fw-bold">This is <strong class="text-danger">SMS</strong></h1>
                      <h3 class="fs-4">Created by Kaneene Joseph Rodney</h3>
                      <p class="mt-4 text-muted">This is A School Online Management And Learning System</p>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="portifolio-item">
                    <img class="w-100 img-thumbnail" src="images/online.svg" alt="checkboxes.svg" />
                    ...
                    <div class="carousel-inner p1">
                        ...
                        <div class="testi-item carousel-item active bg-white shadow-sm rounded p-4 mb-5">
                            <div class="testi-author-info d-flex align-items-center">
                                <img src="images/profile.jpg" alt="profile.jpg" class="rounded-circle" />
